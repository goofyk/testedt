...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураФункциональныхОпций.Вставить("_ДемоИспользоватьНесколькоОрганизаций",Истина);
...
Процедура УстановитьВидимостьНаСервере()
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		...
		"Видимость",
		ПравилаОтправкиСправочников <> "НеСинхронизировать" И СтруктураФункциональныхОпций._ДемоИспользоватьНесколькоОрганизаций);
