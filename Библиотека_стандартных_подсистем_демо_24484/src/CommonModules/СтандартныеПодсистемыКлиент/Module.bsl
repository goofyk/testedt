...
#Если ВебКлиент Тогда
	ОпцииИнтерфейсаСтруктура = Новый Структура;
	ОбщегоНазначенияКлиентСервер.ДополнитьСтруктуру(ОпцииИнтерфейсаСтруктура, ОпцииИнтерфейса, Истина);
	ОпцииИнтерфейса = ОпцииИнтерфейсаСтруктура;
#Иначе
