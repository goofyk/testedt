...
//
//  Параметры:
//    ВидПроверок - Строка, Массив, СправочникСсылка.ВидыПроверок - Переданные данные
//                  обрабатываются согласно функции КонтрольВеденияУчета.СводнаяИнформацияПоВидамПроверки
//                  после чего открывается отчет с отбором по найденному виду проблем.
//
// Пример:
