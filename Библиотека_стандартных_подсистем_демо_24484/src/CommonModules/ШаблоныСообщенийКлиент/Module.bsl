...
Процедура СформироватьСообщение(ПредметСообщения, ВидСообщения, ОписаниеОповещенияОЗакрытии = Неопределено, 
	...
	ПараметрыФормы = Новый Структура("Предмет, ВидСообщения, ВладелецШаблона, ПараметрыСообщения");
	ПараметрыФормы.Предмет            = ПредметСообщения;
	ПараметрыФормы.ВидСообщения       = ВидСообщения;
	ПараметрыФормы.ВладелецШаблона    = ВладелецШаблона;
	ПараметрыФормы.ПараметрыСообщения = ПараметрыСообщения;
