...
Процедура ПриЗаполненииСпискаТекущихДел(ТекущиеДела) Экспорт
	...
	Если РазделАдминистрирование = Неопределено Тогда
		...
		Разделы = МодульТекущиеДелаСервер.РазделыДляОбъекта("Константа.ПараметрыЦентраМониторинга");
	КонецЕсли;
...
Процедура СобратьДампы(Параметры) Экспорт
...
Процедура ОтправитьДампы(Параметры) Экспорт
	...
	Если Параметры.СпрашиватьПередОтправкой Тогда
		...
		Если Параметры.Свойство("ВариантыДампов") И Параметры.ВариантыДампов.Количество() Тогда
			...
			ШаблонЗапросДляОтправки = Нстр("ru = 'Для отправки подготовлены дампы (%1 шт.)
