...
Процедура ПриНастройкеВариантовОтчетов(Настройки) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.ОтчетОДвиженияхДокумента") Тогда
		МодульОтчетОДвиженияхДокумента = ОбщегоНазначения.ОбщийМодуль("Отчеты.ОтчетОДвиженияхДокумента");
		МодульОтчетОДвиженияхДокумента.ПриНастройкеВариантовОтчетов(Настройки);
	КонецЕсли;
...
Процедура ПередДобавлениемКомандОтчетов(КомандыОтчетов, НастройкиФормы, СтандартнаяОбработка) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.ОтчетОДвиженияхДокумента") Тогда
		МодульОтчетОДвиженияхДокумента = ОбщегоНазначения.ОбщийМодуль("Отчеты.ОтчетОДвиженияхДокумента");
		МодульОтчетОДвиженияхДокумента.ПередДобавлениемКомандОтчетов(КомандыОтчетов, НастройкиФормы, СтандартнаяОбработка);
	КонецЕсли;
