...
Процедура ОбновитьНаИсправительнуюВерсию(ПутьКФайлуОбновления) Экспорт
	...
	ЗапуститьПриложение(Кавычка + КаталогПрограммы + "1cv8.exe" + Кавычка + " DESIGNER"
		...
		+ " /UpdateCfg "          + Кавычка + ПутьКФайлуОбновления + Кавычка
		+ " -Settings "           + Кавычка + ПутьКФайлуНастроек + Кавычка
		+ " -force"
...
Процедура УстановитьФлажкиОбщихКоманд()
	...
	Команды.Вставить("ОбщаяКоманда.НастроитьПараметрыТранспортаСообщенийОбмена", Подсистема);
