...
Процедура ПриИзмененииСостоянияПодключенияОбсуждений(ОбсужденияПодключены = Неопределено)
	...
	Элементы.ОбработкаПодключениеОбсужденийОткрыть.Видимость = Не ОбсужденияПодключены;
	Элементы.ОбработкаПодключениеОбсужденийОтключиться.Видимость = ОбсужденияПодключены;
